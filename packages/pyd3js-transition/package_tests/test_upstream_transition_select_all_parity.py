"""Ports of d3-transition@3.0.1 ``selectAll-test.js``."""
...
def test_transition_select_all_string_groups_children() -> None:
...
def test_transition_select_all_function_groups_children() -> None:
    g.document = parse_html(
        """
        <html>
          <body>
