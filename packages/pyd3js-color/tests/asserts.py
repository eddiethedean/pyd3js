...
def assert_hsl_equal(
    actual: object, h: float, s: float, l: float, opacity: float
) -> None:
...
def assert_lab_equal(
    actual: object, l: float, a: float, b: float, opacity: float
) -> None:
...
def assert_hcl_equal(
    actual: object, h: float, c: float, l: float, opacity: float
) -> None:
