...
def test_upstream_d3_path_mocha_suite_passes() -> None:
    """Run the vendored upstream `d3-path` JS test suite (Mocha) and assert it passes."""
    ...
    if not node_modules.is_dir():
        pytest.skip(
            "Upstream d3-path node_modules not installed. Run: "
