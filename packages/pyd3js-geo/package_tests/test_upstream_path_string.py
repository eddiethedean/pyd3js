...
def test_geopath_string_renders_point_and_multipoint():
    ...
    assert_path_equal(
        ...
        .pointRadius(10)({"type": "Point", "coordinates": [-63, 18]}),
...
def test_geopath_string_renders_lines_polygons_and_containers():
    ...
    assert_path_equal(
        render({"type": "GeometryCollection", "geometries": [polygon]}),
        "M165,160L170,160L170,165Z",
    )
    assert_path_equal(
        render({"type": "Feature", "geometry": polygon}), "M165,160L170,160L170,165Z"
    )
    assert_path_equal(
        render(
            {
...
def test_geopath_string_line_then_point_does_not_share_state():
    ...
    assert_path_equal(
        path({"type": "LineString", "coordinates": [[-63, 18], [-62, 18], [-62, 17]]}),
        "M165,160L170,160L170,165",
    )
    assert_path_equal(
