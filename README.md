...
`packages/dylaunator` and `packages/pyrobust-predicates` additionally vendor upstream JS test fixtures for parity with [mapbox/delaunator@v5.0.1](https://github.com/mapbox/delaunator/releases/tag/v5.0.1) and [mourner/robust-predicates@v3.0.3](https://github.com/mourner/robust-predicates/releases/tag/v3.0.3). Each package README summarizes API and testing; provenance and test-file mapping live in [`packages/dylaunator/docs/UPSTREAM_TESTS.md`](packages/dylaunator/docs/UPSTREAM_TESTS.md) and [`packages/pyrobust-predicates/docs/UPSTREAM_TESTS.md`](packages/pyrobust-predicates/docs/UPSTREAM_TESTS.md).
